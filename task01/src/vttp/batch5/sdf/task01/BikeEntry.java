...
public class BikeEntry {
	...
	public BikeEntry(String season, String month, String holiday, String weekday, String weather, String temperature,
	String humidity, String windspeed, String casual, String registered) {
		setSeason(toInt(season));
		setMonth(toInt(month));
		setHoliday(toBoolean(holiday));
		setWeekday(toInt(weekday));
		setWeather(toInt(weather));
		setTemperature(toFloat(temperature));
		setHumidity(toFloat(humidity));
		setWindspeed(toFloat(windspeed));
		setCasual(toInt(casual));
		setRegistered(toInt(registered));
	}
	@Override
	public String toString() {
		return season + "," + month + "," + holiday + "," + weekday
